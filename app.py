...
# ---------------------------------------------------------------------
# Minimal directions used by the validator
# ---------------------------------------------------------------------
...
# ---------------------------------------------------------------------
# Validation (simplified version from your original)
# ---------------------------------------------------------------------
def validate_day_paths(
    grid,
    day_paths,
    start_d,
    max_days,
    ...
    return True, plastic_by_day, distance_by_day, distance_by_day_steps


# ---------------------------------------------------------------------
# Plot last frame only (no animation)
# ---------------------------------------------------------------------
def draw_last_frame(grid, day_paths, plastic_by_day, distance_by_day_steps):
    fig, ax = plt.subplots(figsize=(6, 6))
    sns.heatmap(grid, ax=ax, cmap='YlGnBu', annot=True,
                fmt='d', cbar=False, square=True)
    ax.invert_yaxis()
...
# Streamlit UI
# ---------------------------------------------------------------------
st.title('Validate and Plot Grid Path')
